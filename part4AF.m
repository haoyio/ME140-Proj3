function output = part4AF(input)

% struct output = part4AF(bool isVarK, struct input)
% 
...
[work_TUR, eff_TUR] = getWorkEffTurbAF(To4,Po4,To5,Po5,mdot_air,mdot_fuel,isVarK);
...
output.eff_NOZ = getEffNozzAF(To5,Po5,To8,v8,P8,isVarK, mdot_air, mdot_fuel);

% Compute apparent combustion efficiency
output.eff_CMB = getEffCombAF(To3,To4,isVarK,mdot_air,mdot_fuel);
